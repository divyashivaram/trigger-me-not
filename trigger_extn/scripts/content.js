const abuseWords = ['sexual', 'victims', 'assault', 'violence', 'sexually', 'abused', 'offences', 'harassment',
    ...
    function(request, sender, sendResponse) {
        if (request.action === "getSource") {
            ...
            $(".lLrAF").each(function() {
                ...
                const intersection = abuseWords.filter(element => wordInTitle.includes(element));
